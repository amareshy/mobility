...
public class MobileOTPVeifyScreen extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mobile_otpveify_screen);
        mSendOtpButton = (Button) findViewById(R.id.send_otp_button);
...
//        setViewBackground(editText, getResources().getDrawable(R.drawable.textfield_focused_holo_light));
    ...
    public class MainLayout extends LinearLayout {
        ...
        public MainLayout(Context context, AttributeSet attributeSet) {
            ...
            inflater.inflate(R.layout.pin_input_layout, this);
        }
